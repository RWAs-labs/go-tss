...
// MuseChainTSSMessageType represent the message type used in MuseChain TSS
type MuseChainTSSMessageType uint8

const (
	// TSSKeyGenMsg is the message directly generated by tss-lib package
	TSSKeyGenMsg MuseChainTSSMessageType = iota
...
func (t MuseChainTSSMessageType) String() string {
	switch t {
	case TSSKeyGenMsg:
		return "TSSKeyGenMsg"
	case TSSKeySignMsg:
...
type WrappedMessage struct {
	MessageType MuseChainTSSMessageType `json:"message_type"`
...
type TssControl struct {
	...
	RequestType MuseChainTSSMessageType `json:"request_type"`
